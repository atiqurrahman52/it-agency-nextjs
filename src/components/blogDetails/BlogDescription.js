...
const BlogDescription = () => {
    return (
        ...
        <div className="container">
            <h5 className="font-openSans font-extrabold text-2xl text-black_color mb-4">Introduction</h5>
            <p className="font-Inter font-medium text-sm md:text-base text-black/60">
            ...
            <p className="font-NotoSerif font-extrabold text-base text-[#08192B] mt-11">
            ...
            <p className="font-Inter font-medium text-sm md:text-base text-black/80 mt-4">Collaboratively deploy
                intuitive partnerships whereas customized e-markets. Energistically maintain
                performance based strategic theme areas whereas just in time methodologies. Phosfluorescently drive
                functionalized intellectual capital and.</p>

            <p className="font-Inter font-medium text-xl text-black_color border-l-2 border-secondary_color pl-2 mt-5">
            ...
            <p className="font-Inter font-medium text-sm md:text-base text-black/80 mt-5">Tristique odio senectus nam
                posuere ornare leo metus, ultricies. Blandit duis ultricies vulputate morbi feugiat cras placerat
                elit. Aliquam tellus lorem sed ac. Montes, sed mattis pellentesque suscipit accumsan. Cursus viverra
                aenean magna risus elementum faucibus molestie pellentesque. Arcu ultricies sed mauris vestibulum.
            </p>
            <h5 className="font-openSans font-extrabold text-2xl text-black_color py-6">Conclusion</h5>
            <p className="font-Inter font-medium text-sm md:text-base text-black/80">
            ...
            <div className="mt-8 md:mt-16">
                <h6 className="font-NotoSerif font-semibold text-sm md:text-base text-[#113355] text-center mb-4">Share this post</h6>
