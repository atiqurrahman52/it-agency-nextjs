...
const BlogDetailsBanner = ({ data }) => {
  ...
  return (
    <div className="blog_hero_bg h-fit bg-no-repeat mt-16 lg:mt-20">
      <div className="container">
        <div className="pt-5 mb-11 md:mb-14 max-w-[768px] mx-auto">
          ...
          <h3 className="font-NotoSerif font-extrabold lsm:text-xl md:text-[40px] leading-[30px] md:leading-[48px] text-black_color text-center mb-6">
        ...
        <div>
          <img
            ...
            src="/assets/images/blog-detail/blog-hero.webp"
            alt=""
          />
        </div>

        <div className="flex flex-col md:flex-row md:justify-between justify-center items-center gap-3 py-10">
          <div className="flex items-center gap-2">
            <span className="font-Inter font-medium text-xs md:text-base text-[#393545]">
              Blog
            </span>

            <CaretRight size={16} className="text-black" />
            <span className="font-Inter font-bold text-xs md:text-base text-primary">
              Category
            </span>
          </div>
