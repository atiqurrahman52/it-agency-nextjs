      ...
      <div className="container">
        <div className="py-8 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <Image
                src="/assets/images/achieve/achieve.webp"
                alt=""
                width={424}
                height={376}
              />
            ...
            <div>
              <h2 className="font-NotoSerif font-black text-lg md:text-3xl mb-4">
                We&apos;ve achieved many world wide awards
              </h2>
              <p className="font-Inter text-sm md:text-base text-black/60 mb-4">
              ...
              <div className="flex items-center gap-2 md:gap-3 mb-3">
                ...
                <p className="font-Inter font-medium text-sm md:text-base text-[#2B2D42]">
                  Lorem Ipsum but their majority have suffered.
                </p>
              </div>
              <div className="flex items-center gap-2 md:gap-3 mb-3">
                <span>
