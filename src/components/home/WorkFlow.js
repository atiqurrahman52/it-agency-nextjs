      ...
      <div className="py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
          <div className="flex flex-col justify-center items-center relative">
            ...
            <h6 className="font-NotoSerif font-black text-xl text-[#08192B] mb-3">
              Ideate
            </h6>
            <span className="font-Inter font-bold text-base text-secondary_color mb-3">
              01.
            </span>
            ...
            <div className="xl:block hidden absolute top-9 -right-[35%]">
              ...
              >
                <path
                  d="M1 14.7031C1 14.7031 32.5273 31.7875 65.7841 9.6746C99.0408 -12.4383 151 14.7031 151 14.7031"
                  stroke="#D4E5F7"
                  strokeWidth="2"
                  strokeLinecap="round"
