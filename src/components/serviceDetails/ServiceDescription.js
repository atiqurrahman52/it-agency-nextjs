    ...
    return (
        <div>
            ...
            <div class="py-8 md:py-16">
                <h4 class="font-NotoSerif font-black text-xl md:text-[32px] text-black_color mb-2">Data Center Service
                </h4>
                <p class="font-SpaceGrotesk font-medium textsm md:text-base text-black/60">
                ...
                <img class="rounded-lg mb-4 md:mb-5" src="/assets/images/service-detail/service-detail.webp" alt="" />
                <p
                    class="font-Poppins font-semibold text-base md:text-xl text-[#002B33] border-l-2 border-[#001A14] pl-4 md:pl-6 mb-8">
                    A Pioneer To The Emerging And Effective Web And CMS Development proficiency and upgrades it.
                </p>
                <p class="font-SpaceGrotesk font-medium text-sm md:text-base text-black/60 mb-4">
                ...
                <h5 class="font-openSans font-extrabold text-2xl text-primary mb-3">Explore our audit & assurance
                    services
                </h5>
                <p class="font-SpaceGrotesk font-medium textsm md:text-base text-black/60">
                ...
                <div class="flex flex-col md:flex-row md:justify-between items-center gap-5 mt-6 md:mt-16">
                    <div
                        class="bg-secondary_color flex items-center justify-center gap-2 w-[164px] h-[60px] rounded-xl">
                        <span>
                        ...
                        <div class="">
                            <span class="block font-SpaceGrotesk text-xs text-white">For Query</span>
                            <span class="block font-NotoSerif font-black text-base text-white">310-437-2766</span>
                        </div>
                    </div>
                    <div>
                        <h6 class="font-NotoSerif font-semibold text-base text-black_color mb-4">Share this post</h6>
                        <div class="flex gap-2">
                            <a href="#"
                                class="bg-[#F4F4F4] w-8 md:w-10 h-8 md:h-10  flex items-center justify-center rounded-full">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
