      ...
      <div className="py-24">
        <div className="container">
          <div className="flex flex-col justify-center items-center">
            <div>
              <h4 className="font-Inter font-bold text-sm md:text-base text-secondary_color text-center">
                Get connect
              </h4>
              <p className="font-NotoSerif font-black text-xl md:text-2xl text-black_color text-center mb-6">
            ...
            <div className="flex items-center px-2 w-auto xl:w-[514px] h-14 md:h-[70px] bg-white rounded drop-shadow-[0_0px_20px_rgba(0,0,0,0.08)]">
              <button
                type=""
                className="bg-[#FFBEAF] w-8 md:w-6 h-[17px] rounded flex justify-center items-center"
              >
                <svg
                  width="13"
                  height="5"
              ...
              <input
                type=""
                name=""
                className="w-full h-14 md:h-[70px] px-3 outline-none text-xs md:text-base"
