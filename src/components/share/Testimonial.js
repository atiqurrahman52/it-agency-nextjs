...
const Testimonial = () => {
  return (
    ...
    >
      {testimonialData.map(
        ({ id, UserImg, userName, designation, comment, date }) => (
            ...
            <SwiperSlide>
              <div className="drop-shadow-[0_1px_3px_rgba(75,75,75,0.06)] bg-white p-4  testimonial-card">
                ...
                <div className="flex justify-between mb-3 md:mb-[14px]">
                  <p className="font-Inter font-semibold text-xs md:text-sm text-secondary_color testimonial-company">
                    {designation}
                  </p>
                  <p className="font-Inter font-semibold text-xs md:text-sm text-[#393545] testimonial-date">
                    {date}
                  </p>
                </div>
                <p className="font-Inter text-sm text-black/40 testimonial-comment">
                  {comment}
                </p>
              </div>
            </SwiperSlide>
